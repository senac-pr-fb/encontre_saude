import"./authService-FkTjPsGX.js";import{c as g}from"./sidebar-BkaUTNX8.js";import{c as v}from"./footer-B06_h6Rx.js";function f(){const s=["Manter a calma durante emergências ajuda você e a vítima.","Sempre verifique se o local é seguro antes de prestar socorro.","Use luvas descartáveis para evitar contaminação ao ajudar alguém.","Se a pessoa estiver inconsciente, chame ajuda imediatamente e verifique a respiração.","Em caso de queimadura, lave a área com água fria por pelo menos 10 minutos.","Nunca retire objetos perfurantes do corpo da vítima — isso pode piorar a lesão.","Evite mover uma pessoa com suspeita de fratura na coluna.","Tenha sempre um kit de primeiros socorros em casa e no carro.","Aprender RCP pode salvar vidas — considere fazer um curso básico.","Em caso de envenenamento, não provoque vômito sem orientação médica."];function n(r){const i=document.getElementById("extra-tip");i.innerHTML=`
    <h3 style="text-align: center;">💡 Você sabia?</h3>
    <p>${r}</p>
  `}function t(){const r=Math.floor(Math.random()*s.length);n(s[r])}t(),setInterval(t,1e4)}function h(){const s=[{title:"Engasgo",content:`
      ...
      `},{title:"Massagem Cardíaca",content:`
      ...
      <p><b>-</b> Uma vez que todas as camadas de pele estão afetadas, os nervos, glândulas, músculos e até órgãos internos podem sofrer lesões graves. Neste tipo de queimadura pode não se sentir dor devido à destruição dos nervos, mas é necessária ajuda médica imediata para evitar complicações graves, assim como infecções.
       `},{title:"Transporte de vítimas",content:`
      ...
      <p><b>-</b> Aguardar o auxílio médico. Caso não seja possível, recomenda-se levar a vítima para o pronto-socorro mais próximo.</p>`}],n={Engasgo:"https://www.youtube.com/embed/C2c0BIJygYI","Massagem Cardíaca":"https://www.youtube.com/embed/sKtHkqUWNgE",Desmaio:"https://www.youtube.com/embed/VxJNguOcYgo",Convulsão:"https://www.youtube.com/embed/sVZaYNL2Vkk",Intoxicação:"https://www.youtube.com/embed/Pm3Iw3pxaS4",Afogamento:"https://www.youtube.com/embed/CiBaKoPl4IM",Queimadura:"https://www.youtube.com/embed/Klcs7ZmMOlE","Transporte de vítimas":"https://www.youtube.com/embed/JttAYDeuSyg",Fratura:"https://www.youtube.com/embed/RT6th-_fbOo"},t=document.getElementById("btns_mae"),r=document.getElementById("info-title"),i=document.getElementById("info-content"),p=document.getElementById("search-input"),m=document.getElementById("infos_bt"),c=document.getElementById("placeholder-info");function d(o){t.innerHTML="",o.forEach(a=>{const e=document.createElement("button");e.className="btns",e.textContent=a.title,e.onclick=()=>{const b=e.classList.contains("active");document.querySelectorAll(".btns").forEach(l=>l.classList.remove("active")),b?(r.textContent="",i.innerHTML="",m.style.display="none",c.style.display="block"):(e.classList.add("active"),u(a))},e.setAttribute("role","listitem"),t.appendChild(e)})}function u(o){const a=n[o.title],e=a?`<iframe width="100%" height="100%" src="${a.replace("watch?v=","embed/")}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`:"";r.textContent=o.title,r.style.color="black",i.innerHTML=`
    <div class="info-left">
      ${e}
    </div>
  ...
  `,m.style.display="block",c.style.display="none"}p.addEventListener("input",()=>{const o=p.value.trim().toLowerCase(),a=o?s.filter(e=>e.title.toLowerCase().includes(o)):s;d(a),a.length||(r.textContent="",i.innerHTML="",m.style.display="none",c.style.display="block")}),d(s),setTimeout(()=>{const o=t.querySelectorAll(".btns");for(const a of o)if(a.textContent==="Engasgo"){a.click();break}},0)}document.addEventListener("DOMContentLoaded",()=>{g(),h(),f(),v()});
