export function infoPrevencao() {
  const data = [
    ...
    },
    {
      ...
      text: `
        Incluir alimentos variados na dieta é fundamental para garantir o aporte de vitaminas, minerais e fibras que o nosso corpo precisa. 
        Frutas ricas em fibras solúveis e antioxidantes auxiliam na digestão e na prevenção de doenças crônicas. 
        Verduras e legumes trazem clorofila, vitaminas A, C e K, além de minerais que fortalecem o sistema imunológico 
        e ajudam na manutenção dos ossos. Cereais integrais, como aveia, quinoa e arroz integral, favorecem o controle da glicemia 
        e prolongam a sensação de saciedade. Peixes gordos, como salmão e sardinha, são fontes de ômega-3, importante para a saúde 
        cardiovascular e cerebral. Castanhas e sementes oferecem gorduras boas e proteínas, contribuindo para a saúde da pele e dos cabelos. 
        Leguminosas, como feijão, lentilha e grão-de-bico, possuem proteínas vegetais e fibras que melhoram o trânsito intestinal. 
        Iogurtes naturais e kefir enriquecem a microbiota intestinal com probióticos. Evitar ultraprocessados reduz o consumo de sódio, açúcares 
        e gorduras trans. Reduzir alimentos com muito sal previne a hipertensão, enquanto controlar o açúcar diminui o risco de diabetes. 
        Substituir bebidas adoçadas por água, chás e água de coco mantém o corpo bem hidratado. Cozinhar em casa permite o uso consciente 
        de temperos e óleos. Investir em métodos de preparo saudáveis, como grelhar, assar e cozinhar no vapor, diminui compostos nocivos. 
    ...
    },
    {
      ...
      text: `
        A saúde mental é tão importante quanto a física e deve ser cuidada diariamente.
        Comece estabelecendo uma rotina de sono regular, pois dormir de 7 a 9 horas por noite melhora o humor e a capacidade cognitiva.
        Praticar exercícios físicos libera endorfinas, hormônios do bem-estar, que auxiliam no controle do estresse e da ansiedade.
        Técnicas de respiração profunda e mindfulness podem ser incorporadas em pausas curtas ao longo do dia, diminuindo a tensão acumulada.
        Manter contato com amigos e familiares gera conexões sociais que atuam como rede de apoio.
        Dedique tempo a hobbies e atividades prazerosas, como leitura, música ou artesanato, para equilibrar a mente.
        Limitar o uso de redes sociais ajuda a reduzir comparações e impactos negativos na autoestima.
        Buscar ajuda profissional, como terapia cognitivo-comportamental, é essencial caso ansiedade ou tristeza persistam.
        Praticar gratidão, anotando três coisas boas de cada dia, melhora a percepção positiva da vida.
        Estabelecer metas realistas e celebrar pequenas conquistas fortalece a motivação.
        Manter alimentação equilibrada e hidratação adequada também influencia diretamente o funcionamento cerebral.
